...
[![Agent deployed and protected](./screenshots/01_agent_protected.png)](./screenshots/01_agent_protected.png)
...
[![Threat Protection policy active](./screenshots/02_threat_protection_policy.png)](./screenshots/02_threat_protection_policy.png)
...
| Category | Action |
|---|---|
| Business / Computing & Internet / Education / Reference / Search Engines | ✅ Allow |
...
[![Web Control blocking instagram.com](./screenshots/03_web_control_blocked.png)](./screenshots/03_web_control_blocked.png)
...
| uTorrent installation attempt | ❌ Blocked by agent — File Sharing category |
...
[![TeamViewer blocked by Sophos agent](./screenshots/04_teamviewer_blocked.png)](./screenshots/04_teamviewer_blocked.png)
...
[![DLP blocking file upload](./screenshots/05_dlp_blocked_upload.png)](./screenshots/05_dlp_blocked_upload.png)
...
[![EICAR blocked and Threat Graph](./screenshots/06_eicar_threat_graph.png)](./screenshots/06_eicar_threat_graph.png)
...
[![App Control — Monitor vs Block](./screenshots/07_monitor_vs_block.png)](./screenshots/07_monitor_vs_block.png)
...
[![Device isolation confirmation](./screenshots/08_device_isolation.png)](./screenshots/08_device_isolation.png)
...
[![Live Discover query results](./screenshots/09_live_discover_results.png)](./screenshots/09_live_discover_results.png)
...
[![Sophos Central reports dashboard](./screenshots/10_reports_dashboard.png)](./screenshots/10_reports_dashboard.png)
...
> All screenshots are in the `/screenshots` folder. Usernames, Windows SID numbers, and third-party account names have been redacted.
...
> *This project reflects a structured hands-on learning process and does not represent production-level enterprise deployment experience. All configurations were performed in an isolated lab environment using a trial license. No production systems were used. EICAR test files are industry-standard, harmless AV test strings — not real malware.*# 🛡️ Hands-On Sophos Intercept X EDR Lab — Policy Design & Threat Validation
